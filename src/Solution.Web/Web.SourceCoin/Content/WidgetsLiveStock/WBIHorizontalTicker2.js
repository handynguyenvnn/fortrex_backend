...
function WBIHorizontalTicker(a) {
    ...
    this.start = function () {
        ...
        div.innerHTML = b;
        document.getElementById("livestock").append(div);
    ...
    this.getSymbolDiv = function (b) {
        ...
        var d = '<span class="WLSymbolItem" id="' + e + '_display"><a class="sym" target="_parent" href="#">';
    ...
    this.UpdateList = function () {
        ...
        $.getJSON("https://widgets.freestockcharts.com/WidgetServer/DynamicLists.ashx?name=" + this.listName + "&senderID=" + this.scollerID + "&take=10&cbust=" + b + "&jsoncallback=?", function (e, f) {
            if ((e != null)) {
    ...
    this.UpdateValues = function () {
        ...
        var c = new Date();
        var b = c.getHours().toString() + c.getMinutes().toString() + c.getSeconds().toString() + c.getMilliseconds().toString();
        $.getJSON("https://widgets.freestockcharts.com/Ajaxserver.aspx?service=DATA&senderID=" + this.scollerID + "&sym=" + this.sub_symbols + "&cbust=" + b + "&jsoncallback=?", function (e, f) {
            if ((e != null)) {
    ...
    this.updateSymbolData = function (d, f, e, k, c) {
        ...
        if (c) {
            ...
            $(m).addClass("dirup");
            $(n).attr("src", "https://widgets.freestockcharts.com/WidgetServer/images/greenup.png");
        } else {
            ...
            $(m).removeClass("dirup");
            $(m).addClass("dirdown");
            $(n).attr("src", "https://widgets.freestockcharts.com/WidgetServer/images/reddown.png")
        }
    }
};